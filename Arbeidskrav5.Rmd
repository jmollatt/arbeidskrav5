...
m3 <- lme4::lmer(post ~ pre + sex + sets+ (1|participant), data = strengthvolume)
s0 <- lm(post ~ pre + sex + sets, data = strength)
summary(m3)
confint(m3)
plot(m3)
...
## Konklusjon
Det er mulig å anta at den gruppen med størst prosentvis fremgang har gjennomgått den intervensjonen med størst effekt på nettopp muskelstyrke og muskelmasse(fettfri masse).
